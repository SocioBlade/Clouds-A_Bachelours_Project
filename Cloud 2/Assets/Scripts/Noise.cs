...
public static class Noise
{
    ...
    public static NoiseMethod[] turbulenceMethods=
    {
        turbulenceStandard,
        turbulenceStandard,
        turbulenceStandard
    ...
    public static NoiseMethod[] marbleMethods=
    {
        marbleStandard,
        marbleStandard,
        marbleStandard
    ...
    {
        point *= frequency;                                                     //Example: if frequency is doubled the pattern changes twice as fast
        ...
        t = Smooth(t);                                                          //Improved smooth step between hashes
    ...
    public static float Perlin1D(Vector3 point, float frequency)
    {
        ...
        float t = Smooth(t0);
        return Mathf.Lerp(v0, v1, t) * 2f;                                      //*2f to normalize it into range 
    }
...
public static float marbleStandard(Vector3 point, float frequency)
    {
        point *= frequency;                                                     //Example: if frequency is doubled the pattern changes twice as fast
        int ix0 = Mathf.FloorToInt(point.x);
        int iy0 = Mathf.FloorToInt(point.y);
    ...
    public static float turbulenceStandard(Vector3 point, float frequency)
    {
        point *= frequency;                                                     //Example: if frequency is doubled the pattern changes twice as fast
        int i0 = Mathf.FloorToInt(point.x);
        float t0 = point.x - i0;
